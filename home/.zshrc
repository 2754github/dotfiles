...
alias tree="eza -aT -I '.devbox|.git|.memo|.next|build|coverage|go|node_modules|out|vendor' -L"
...
export DEVBOX_NO_PROMPT=true # https://www.jetify.com/docs/devbox/faq#how-can-i-prevent-devbox-from-modifying-my-prompt-while-inside-a-shell%E2%80%8B
