...
import { type InferD, type Result } from '../usecase';
import { type Usecase } from '../usecase/creator';
import { type MwContext, type MwLists } from '../usecase/middleware';

export const createFormAction: <
  Middleware extends MwLists,
  Schema extends GenericSchema<
    Record<string, unknown>,
    Record<string, unknown>
  >,
  Handler extends (
    ctx: MwContext<Middleware>,
